...
class WriteRecord {
   public:
    ...
    WriteRecord(WType wtype, const Rid &rid, const RmRecord &old_record, const RmRecord &new_record, const std::string &index_name)
    ...
    inline RmRecord &GetOldRecord() { return record_; }
